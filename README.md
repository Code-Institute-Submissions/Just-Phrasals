...
<h2 align="center"><img src="assets/screenshots/fullsuite.jpg" style="max-height:400px;"></h2>
...
- #### Returning User Goals
  ...
  - c) As a Returning Visitor interested in signing up for the paid course, I want to learn more before signing up.
  - d) As a Returning Visitor interested in signing up for the paid course, I want to contact the course developers with any questions I may have before signing up.

### <u>**Design**</u>

- #### Colors

The overall color scheme of the website contains neutral colors, dark blues, light blues, greys and whites. Buttons are mainly in green to make them stand out, with a yellow border appearing when a user hovers over them. A small use of green and red is used in other areas -- to indicate when a user gets an answer correct/wrong (green tick or red X), while green, red and yellow have been chosen for the buttons for the audio player. 
...
- #### Homepage
    ...
    - **Buttons:** Two striking green buttons have been included which allow the user to access the website's two main areas. The 'Go to Course' button brings them to the directly to the start of the free course; the 'Sign Up for Full Course' button directs them to the signup page.
...
Exercise 4 is based is an audio comprehension exercise, where the user can listen to an audio dialogue using the built-in audio player. The simple audio player contains three buttons, Play (Green), Stop (Red) and Pause (Yellow). 

The user also has access to the transcription of the audio, which, like the verb definition/examples, is hidden from initial view. The user is prompted to click on the transcript bar to toggle show/hide the transcript of the audio.
...
- [Font Awesome:](https://fontawesome.com/)
    - Font Awesome was used to add icons for aesthetic, UX and functional purposes, such as the audio player buttons.
...
#### ***7. Audio Player and Transcript (Over Exercise - 5)***
 ...
 - Pause button: Changes color when hovered over. When clicked, it activates a Javascript funtion that pauses the the audio dialogue.
 ...
 - Transcript bar toggle click show/hide: Changes color when hovered over. When clicked, the transcript reveals the transcription (screenshot one) When clicked again the transcription is hidden once again (screenshot two).
    ...
    <img src="assets/screenshots/transcript-show.jpg" alt="audio-transcript-screenshot"> <img src="assets/screenshots/audio-player.jpg" alt="audio-player-screenshot">
...
- All images have been sourced from Adobe Stock, for which the developer has a licence:
    ...
    8. [Out page image](https://stock.adobe.com/ie/images/beautiful-old-woman-is-smiling-toothy/224358102)
